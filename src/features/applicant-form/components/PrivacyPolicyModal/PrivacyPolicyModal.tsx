import css from './PrivacyPolicyModal.module.scss'
...
const PrivacyPolicyModal = ({ isShowed, onClickSubmit, onClickClose }: TPrivacyPolicyModalProps) => {
  return (
    <Modal
      isShowed={isShowed}
      containerClassName={css.modalContainer}
    >
      <button className={css.closeButton} onClick={onClickClose}><CloseIcon /></button>
      <div className={css.title}>Политика конфиденциальности</div>
      ...
      <div className={css.footer}>
        <Button className={css.button} onClick={() => onClickSubmit()}>Согласен</Button>
      </div>
    </Modal>
  )
}
